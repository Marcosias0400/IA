...
Licencitrua de Matematica Algoritmica
INTRODUCCION A LA INTELIGENCIA ARTIFICIAL
Autor: Ortiz Ortiz Bosco
Titulo: Laberinto
"""
#------------------------------------------
# Impotacion de los modulos random
#datetime,csv,os,tk,Enum,collections
...
class agent:
    ...
    def __init__(self,parentMaze,x=None,y=None,shape='square',goal=None,filled=False,footprints=False,color:COLOR=COLOR.blue):
        ...
        self.color=color
        #++++++++++++++++++++++++++++++++++
        # Revisa si las cadenas de caracter
        # son elementos de la tupla de 
        # COLOR
    ...
    def y(self):
        return self._y
    #======================================
    # Define o cambia la posicion en y 
    @y.setter
    def y(self,newY):
        self._y=newY
    ...
    #======================================
    # Asignacion del vector posicion (x,y)
    @position.setter
    ...
    #======================================
    # Rotacion del agente en contra-sentido 
    ...
    #======================================
    # Rotacion en sentido de las manecillas
    # de reloj
    def _RCW(self):
        '''
...
class textLabel:
    ...
    def __init__(self,parentMaze,title,value):
        ...
        self.drawLabel()
    #======================================
    # Retorna el valor de la interfaz
    @property
    def value(self):
        return self._value
    #======================================
...
class maze:
    ...
    # El tamnyo por defecto es 10 x 10
    def __init__(self,rows=10,cols=10):
        ...
        self.cols=cols
        #++++++++++++++++++++++++++++++++++
        # Maze map: dicconario de celdas
        # con valor de otro diccionario
        # de direcciones y valores de 
        # bloqueo 0 y apertura 1
        self.maze_map={}
        #++++++++++++++++++++++++++++++++++
        self.grid=[]
        self.path={} 
        ...
        self.markCells=[]
    #======================================
    # Propiedad de mallado
    @property
    def grid(self):
        return self._grid
    #======================================
    # Instanciador del mallado
    @grid.setter        
    def grid(self,n):
        self._grid=[]
        y=0
        for n in range(self.cols):
            ...
            for m in range(self.rows):
                ...
                x = x + 1 
    #======================================
    # Revisa si el camino al este es 
    # accesible
    ...
    #======================================
    # Revisa si el camino al oeste es 
    # accesible
    ...
    #======================================
    # REvisa si el camino al norte es 
    # accesible
    ...
    def CreateMaze(self,x=1,y=1,pattern=None,loopPercent=0,saveMaze=False,loadMaze=None,theme:COLOR=COLOR.dark):
        ...
        #++++++++++++++++++++++++++++++++++
        # Evita que salgan demasidas celdas
        # Sin muros en todas direcciones
        def isCyclic(cell1,cell2):
            ...
            return ans
        #++++++++++++++++++++++++++++++++++
        # Busqueda a anchura de graficas
        def BFS(cell):
            '''
        ...
        if not loadMaze:
            ...
            if loopPercent!=0:
             ...
             #/////////////////////////////
        #..................................
        # Generacion del laberinto desde 
        # un archivo .csv
        else:
    ...
    def _drawMaze(self,theme):
        ...
        #..................................
    #++++++++++++++++++++++++++++++++++++++
    # Dibujado de las celdas en bruto
    ...
    #++++++++++++++++++++++++++++++++++++++
    #Habilitadion de las teclas flecha
    ...
    #++++++++++++++++++++++++++++++++++++++
    # Habilitacion de las teclas W,A,S,D
    ...
    #++++++++++++++++++++++++++++++++++++++
    # Trazado del camino por el agente
